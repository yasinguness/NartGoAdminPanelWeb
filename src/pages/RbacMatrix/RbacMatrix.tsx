      ...
      <Container maxWidth="xl">
        ...
        {view === 'MATRIX' && (
          <Paper variant="outlined" sx={{ borderRadius: 2, bgcolor: '#0A130F', borderColor: 'rgba(201,162,39,0.12)', overflow: 'hidden' }}>
            <Box sx={{ px: 2.5, py: 2, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
              ...
              <Typography sx={{ fontSize: 10, color: 'rgba(243,238,224,0.45)', fontStyle: 'italic', mt: 0.5 }}>
                ...
                <TableHead>
                  <TableRow>
                    <TableCell sx={{
                      ...
                      bgcolor: '#0A130F !important',
                      fontSize: 10, fontWeight: 800, letterSpacing: 1, color: 'rgba(243,238,224,0.5) !important', textTransform: 'uppercase',
                      minWidth: 240,
                    }}>
                      Route
                    </TableCell>
                    {ALL_ROLES.map(r => (
                      <TableCell
                        key={r}
                        align="center"
                        sx={{ fontSize: 9, fontWeight: 800, letterSpacing: 0.5, color: 'rgba(243,238,224,0.5) !important', textTransform: 'uppercase', bgcolor: 'rgba(0,0,0,0.2)', whiteSpace: 'nowrap' }}
                      >
                    ...
                    return (
                      <TableRow key={route.path} hover sx={{ '&:hover': { bgcolor: 'rgba(201,162,39,0.03) !important' } }}>
                        <TableCell sx={{
                          ...
                          {route.description && (
                            <Typography sx={{ fontSize: 9, color: 'rgba(243,238,224,0.45)', fontStyle: 'italic', fontWeight: 400 }}>
                              {route.description}
                            </Typography>
                          )}
                        </TableCell>
                        ...
                        {r.percentOfTotal !== undefined && (
                          <Stack spacing={0.5}>
                            ...
                            <LinearProgress
                              ...
                              sx={{ height: 4, borderRadius: 2, bgcolor: 'rgba(255,255,255,0.05)', '& .MuiLinearProgress-bar': { bgcolor: '#C9A227' } }}
                            />
                          </Stack>
                        )}
                      </TableCell>
        ...
        {view === 'AUDIT' && (
          <Paper variant="outlined" sx={{ borderRadius: 2, bgcolor: '#0A130F', borderColor: 'rgba(201,162,39,0.12)', overflow: 'hidden' }}>
                ...
                <TableBody>
                  {recentChanges.map((c, idx) => (
                    <TableRow key={idx} hover>
                      ...
                      <TableCell sx={{ fontSize: 11, color: '#F3EEE0' }}>
                        {c.targetEmail || '—'}
                      </TableCell>
                      <TableCell sx={{ fontSize: 10, fontFamily: 'monospace', color: 'rgba(243,238,224,0.6)', maxWidth: 300 }}>
            ...
            <Box sx={{ px: 2.5, py: 1.5, borderTop: '1px solid rgba(255,255,255,0.05)', textAlign: 'right' }}>
        ...
        {(!isLoading && !data) && (
          <Alert severity="info" icon={false} sx={{ mt: 3, bgcolor: 'rgba(245,158,11,0.08)', border: '1px solid rgba(245,158,11,0.25)', color: 'rgba(243,238,224,0.85)' }}
