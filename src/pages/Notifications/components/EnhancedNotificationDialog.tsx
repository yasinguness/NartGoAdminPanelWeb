                        ...
                        <Box sx={{ borderBottom: 1, borderColor: 'divider', mb: 2 }}>
                            <Tabs
                                ...
                                onChange={(_, newValue) => {
                                    ...
                                    if (newValue === 2 && (!formData.title || !formData.content)) {
                        ...
                        <Stack spacing={4} sx={{ flexGrow: 1, overflowY: 'auto' }}>
                            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                ...
                                <Box sx={{
                                    ...
                                    {/* Status Bar */}
                                    <Box sx={{ p: '25px 20px 10px', display: 'flex', justifyContent: 'space-between', color: '#fff' }}>
                                        <Typography variant="caption" sx={{ fontWeight: 700, fontSize: '0.65rem' }}>9:41</Typography>
                                        <Stack direction="row" spacing={0.5} alignItems="center">
                                            <NotificationsIcon sx={{ fontSize: 10 }} />
                                            <Box sx={{ width: 10, height: 6, border: '1px solid #fff', borderRadius: '2px' }} />
                                        </Stack>
                                    </Box>
                                    ...
                                    <Box sx={{
                                        ...
                                        <motion.div
                                            ...
                                            key={(formData.title || '') + (formData.content || '')}
                                        >
                                            <Box sx={{
                                                ...
                                                <Stack direction="row" spacing={1} alignItems="center" mb={1}>
                                                    <Box sx={{
                                                        ...
                                                        <NotificationsIcon sx={{ fontSize: 10, color: '#fff' }} />
                                                    </Box>
                                                    <Typography variant="caption" sx={{ fontWeight: 800, color: 'text.primary', flexGrow: 1, fontSize: '0.7rem' }}>
                                                        NartGo Admin
                                                    </Typography>
                                                ...
                                                <Typography variant="caption" sx={{ fontWeight: 800, color: 'text.primary', display: 'block', mb: 0.5, fontSize: '0.75rem', lineHeight: 1.2 }}>
                                                    {formData.title || 'Bildirim Başlığı'}
                                                </Typography>
                                                <Typography variant="caption" sx={{ color: 'text.secondary', lineHeight: 1.3, display: 'block', fontSize: '0.65rem' }}>
                                                    {previewContent || formData.content || 'Bildirim içeriği buraya gelecek. Metin yazdıkça güncellenecek...'}
                                                </Typography>
                                            </Box>
                                        </motion.div>
                                    </Box>
                            ...
                            {formData.sendEmail && (
                                <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                                    ...
                                    <Card variant="outlined" sx={{
                                        ...
                                        <Box sx={{ p: 1, bgcolor: '#f8fafc', borderBottom: '1px solid', borderColor: 'divider', display: 'flex', alignItems: 'center', gap: 0.5 }}>
                                            ...
                                            <Box sx={{ ml: 1, flexGrow: 1, height: 16, bgcolor: '#e2e8f0', borderRadius: 1 }} />
                                        </Box>

                                        <Box sx={{ p: 2 }}>
                                            <Typography variant="body2" sx={{ fontWeight: 800, mb: 1, fontSize: '0.8rem' }}>
                                                Konu: {formData.title || 'Bildirim Başlığı'}
                                            </Typography>

                                            <Box sx={{ bgcolor: '#f8fafc', p: 2, borderRadius: 2 }}>
                                                <Typography variant="body2" sx={{ fontWeight: 700, mb: 1, fontSize: '0.8rem' }}>Merhaba,</Typography>
                                                <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.6, whiteSpace: 'pre-line', fontSize: '0.75rem' }}>
                                                    {previewContent || formData.content || 'E-posta içeriği önizlemesi...'}
                                                </Typography>
                                            </Box>
                                        </Box>
                                    </Card>
            ...
            <DialogActions sx={{ px: 3, py: 2, borderTop: '1px solid', borderColor: 'divider' }}>
                ...
                {activeTab < 2 ? (
                    ...
                    <Button
                        ...
                        variant="contained"
                        disabled={!isValid || (!formData.title || !formData.content)}
                        startIcon={<SendIcon />}
                        color="primary"
                    >
                        Bildirimi İzle / Gönder
                    </Button>
                )}
            </DialogActions>

            <Dialog open={confirmDialogOpen} onClose={() => setConfirmDialogOpen(false)} maxWidth="xs" fullWidth>
                <DialogTitle sx={{ display: 'flex', alignItems: 'center', gap: 1, color: 'warning.main', fontWeight: 800 }}>
                    <WarningIcon /> Onay Gerekli
                </DialogTitle>
                <DialogContent>
                    <Typography gutterBottom variant="body1">
                        Bu bildirimi hedefteki kullanıcılara göndermek üzeresiniz.
                    </Typography>
                    <Box sx={{ bgcolor: 'action.hover', p: 2, borderRadius: 2, mt: 2 }}>
                        <Typography variant="body2" sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                            <span>Alıcı Türü:</span> <strong>{formData.recipientType}</strong>
                        </Typography>
                        <Typography variant="body2" sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                            <span>Öncelik:</span> <strong>{formData.priority}</strong>
                        </Typography>
                        <Typography variant="body2" sx={{ display: 'flex', justifyContent: 'space-between' }}>
                            ...
                            <strong>
                                {[
                                    formData.sendPush && 'Push',
                                    formData.sendEmail && 'Email',
                                    formData.sendWebSocket && 'Web',
                                    formData.sendTelegram && 'Telegram'
                                ].filter(Boolean).join(', ')}
                            </strong>
                        </Typography>
                        {formData.recipientType === RecipientType.SPECIFIC_USERS && formData.emailList && (
                            <Typography variant="body2" sx={{ display: 'flex', justifyContent: 'space-between', mt: 1, color: 'success.main' }}>
                                <span>Toplam Alıcı:</span> <strong>{formData.emailList.length} Kişi</strong>
                            </Typography>
                        )}
                    </Box>
                ...
                <DialogActions>
                    ...
                    <Button onClick={handleConfirmSubmit} variant="contained" color="warning" autoFocus startIcon={<SendIcon />}>
                        Evet, Gönder
                    </Button>
                </DialogActions>
            </Dialog>
