...
const menuItems = [
    ...
    { text: 'Event Operations', icon: <AdminPanelSettingsIcon />, path: '/event-operations' },
    { text: 'Sales Command', icon: <TrendingUpIcon />, path: '/sales-command' },
    { text: 'Venue Inventory', icon: <HomeWork />, path: '/venue-inventory' },
    { text: 'Box Office', icon: <PointOfSaleIcon />, path: '/box-office' },
    { text: 'Settlement & Finance', icon: <AccountBalanceIcon />, path: '/settlement-finance' },
    { text: 'Gate Ops Live', icon: <SensorsIcon />, path: '/gate-ops' },
    { text: 'Customer Support', icon: <SupportIcon />, path: '/customer-support' },
    { text: 'Campaign Engine', icon: <CampaignIcon />, path: '/campaign-engine' },
    ...
    { text: 'Sub Merchants', icon: <AccountBalanceIcon />, path: '/sub-merchants' },
